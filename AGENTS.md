...
If `BOOTSTRAP.md` exists, read it first. Treat it as compatibility/bootstrap context and only delete it if the file itself explicitly tells you to.
...
This repo is a Swift / Xcode / visionOS workspace, not a Node app.
