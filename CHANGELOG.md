...
### Added
- **New Releases section in DiscoverView**: Added dedicated "New Releases" row showing movies released in the last 90 days (up to today). Uses TMDB discover API with date filtering.
- **Coming Soon / Future Releases section in DiscoverView**: Added dedicated "Coming Soon" row showing upcoming movies (release date > today). Uses TMDB upcoming category.
